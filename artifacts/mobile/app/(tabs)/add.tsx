  ...
  return (
    <Pressable
      style={[
        styles.chip,
        selected && {
          backgroundColor: bg ?? Colors.blueMuted,
          borderColor: color ?? Colors.blue,
        },
      ]}
      onPress={() => { onPress(); Haptics.selectionAsync(); }}
    >
      <Text style={[styles.chipText, selected && { color: color ?? Colors.blue }]}>
        {label}
      </Text>
    </Pressable>
  );
        ...
        <Section title="AI Chart Scan">
          <View style={styles.scanButtons}>
            <Pressable
              ...
              disabled={scanning}
            >
              <Feather name="image" size={18} color={Colors.blue} />
            ...
            <Pressable
              ...
              disabled={scanning}
            >
              <Feather name="camera" size={18} color={Colors.blue} />
